...
privileged aspect OBJEKT_INTSIDENDIS_Roo_Entity {
    ...
    public void OBJEKT_INTSIDENDIS.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            OBJEKT_INTSIDENDIS attached = OBJEKT_INTSIDENDIS.findOBJEKT_INTSIDENDIS(this.objektIntsidendisId);
    ...
    public static OBJEKT_INTSIDENDIS OBJEKT_INTSIDENDIS.findOBJEKT_INTSIDENDIS(Long objektIntsidendisId) {
        if (objektIntsidendisId == null) return null;
        return entityManager().find(OBJEKT_INTSIDENDIS.class, objektIntsidendisId);
    }
