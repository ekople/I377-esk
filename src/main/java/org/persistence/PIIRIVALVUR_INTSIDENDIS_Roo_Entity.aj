...
privileged aspect PIIRIVALVUR_INTSIDENDIS_Roo_Entity {
    ...
    public void PIIRIVALVUR_INTSIDENDIS.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            PIIRIVALVUR_INTSIDENDIS attached = PIIRIVALVUR_INTSIDENDIS.findPIIRIVALVUR_INTSIDENDIS(this.piirivalvurIntsidendisId);
    ...
    public static PIIRIVALVUR_INTSIDENDIS PIIRIVALVUR_INTSIDENDIS.findPIIRIVALVUR_INTSIDENDIS(Long piirivalvurIntsidendisId) {
        if (piirivalvurIntsidendisId == null) return null;
        return entityManager().find(PIIRIVALVUR_INTSIDENDIS.class, piirivalvurIntsidendisId);
    }
