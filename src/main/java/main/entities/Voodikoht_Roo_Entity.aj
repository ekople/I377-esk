...
privileged aspect Voodikoht_Roo_Entity {
    ...
    @Column(name = "id")
    private Long Voodikoht.id;
    
    @Version
    @Column(name = "version")
    private Integer Voodikoht.version;
    
    public Long Voodikoht.getId() {
        return this.id;
    }
    
    public void Voodikoht.setId(Long id) {
        this.id = id;
    }
    ...
    public void Voodikoht.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Voodikoht attached = Voodikoht.findVoodikoht(this.id);
    ...
    public static Voodikoht Voodikoht.findVoodikoht(Long id) {
        if (id == null) return null;
        return entityManager().find(Voodikoht.class, id);
    }
