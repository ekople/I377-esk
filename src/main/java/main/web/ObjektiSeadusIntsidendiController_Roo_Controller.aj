...
privileged aspect ObjektiSeadusIntsidendiController_Roo_Controller {
    ...
    public String ObjektiSeadusIntsidendiController.create(@Valid ObjektiSeadusIntsidendi objektiSeadusIntsidendi, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/objektiseadusintsidendis/" + encodeUrlPathSegment(objektiSeadusIntsidendi.getId().toString(), httpServletRequest);
    }
    ...
    public String ObjektiSeadusIntsidendiController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("objektiseadusintsidendi", ObjektiSeadusIntsidendi.findObjektiSeadusIntsidendi(id));
    ...
    public String ObjektiSeadusIntsidendiController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("objektiSeadusIntsidendi", ObjektiSeadusIntsidendi.findObjektiSeadusIntsidendi(id));
        return "objektiseadusintsidendis/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String ObjektiSeadusIntsidendiController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        ObjektiSeadusIntsidendi.findObjektiSeadusIntsidendi(id).remove();
        uiModel.asMap().clear();
