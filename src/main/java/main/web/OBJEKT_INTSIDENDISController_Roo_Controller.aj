...
privileged aspect OBJEKT_INTSIDENDISController_Roo_Controller {
    ...
    public String OBJEKT_INTSIDENDISController.create(@Valid OBJEKT_INTSIDENDIS OBJEKT_INTSIDENDIS, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/objekt_intsidendiss/" + encodeUrlPathSegment(OBJEKT_INTSIDENDIS.getObjektIntsidendisId().toString(), httpServletRequest);
    }
    ...
    public String OBJEKT_INTSIDENDISController.show(@PathVariable("objektIntsidendisId") Long objektIntsidendisId, Model uiModel) {
        uiModel.addAttribute("objekt_intsidendis", OBJEKT_INTSIDENDIS.findOBJEKT_INTSIDENDIS(objektIntsidendisId));
    ...
    public String OBJEKT_INTSIDENDISController.updateForm(@PathVariable("objektIntsidendisId") Long objektIntsidendisId, Model uiModel) {
        uiModel.addAttribute("OBJEKT_INTSIDENDIS", OBJEKT_INTSIDENDIS.findOBJEKT_INTSIDENDIS(objektIntsidendisId));
        return "objekt_intsidendiss/update";
    }
    
    @RequestMapping(value = "/{objektIntsidendisId}", method = RequestMethod.DELETE)
    public String OBJEKT_INTSIDENDISController.delete(@PathVariable("objektIntsidendisId") Long objektIntsidendisId, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        OBJEKT_INTSIDENDIS.findOBJEKT_INTSIDENDIS(objektIntsidendisId).remove();
        uiModel.asMap().clear();
