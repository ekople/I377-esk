...
privileged aspect VahtkonndPiiriloigulController_Roo_Controller {
    ...
    public String VahtkonndPiiriloigulController.create(@Valid VahtkonndPiiriloigul vahtkonndPiiriloigul, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/vahtkonndpiiriloiguls/" + encodeUrlPathSegment(vahtkonndPiiriloigul.getId().toString(), httpServletRequest);
    }
    ...
    public String VahtkonndPiiriloigulController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("vahtkonndpiiriloigul", VahtkonndPiiriloigul.findVahtkonndPiiriloigul(id));
    ...
    public String VahtkonndPiiriloigulController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("vahtkonndPiiriloigul", VahtkonndPiiriloigul.findVahtkonndPiiriloigul(id));
        return "vahtkonndpiiriloiguls/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String VahtkonndPiiriloigulController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        VahtkonndPiiriloigul.findVahtkonndPiiriloigul(id).remove();
        uiModel.asMap().clear();
