...
privileged aspect VoimalikAlluvusController_Roo_Controller {
    ...
    public String VoimalikAlluvusController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("voimalikalluvus", VoimalikAlluvus.findVoimalikAlluvus(id));
    ...
    public String VoimalikAlluvusController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("voimalikAlluvus", VoimalikAlluvus.findVoimalikAlluvus(id));
        return "voimalikalluvuses/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String VoimalikAlluvusController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        VoimalikAlluvus.findVoimalikAlluvus(id).remove();
        uiModel.asMap().clear();
