...
privileged aspect IntsidendiLiikController_Roo_Controller {
    ...
    public String IntsidendiLiikController.create(@Valid IntsidendiLiik intsidendiLiik, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/intsidendiliiks/" + encodeUrlPathSegment(intsidendiLiik.getId().toString(), httpServletRequest);
    }
    ...
    public String IntsidendiLiikController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("intsidendiliik", IntsidendiLiik.findIntsidendiLiik(id));
    ...
    public String IntsidendiLiikController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("intsidendiLiik", IntsidendiLiik.findIntsidendiLiik(id));
        return "intsidendiliiks/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String IntsidendiLiikController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        IntsidendiLiik.findIntsidendiLiik(id).remove();
        uiModel.asMap().clear();
