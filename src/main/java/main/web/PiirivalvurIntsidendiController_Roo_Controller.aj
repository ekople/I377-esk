...
privileged aspect PiirivalvurIntsidendiController_Roo_Controller {
    ...
    public String PiirivalvurIntsidendiController.create(@Valid PiirivalvurIntsidendi piirivalvurIntsidendi, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/piirivalvurintsidendis/" + encodeUrlPathSegment(piirivalvurIntsidendi.getId().toString(), httpServletRequest);
    }
    ...
    public String PiirivalvurIntsidendiController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("piirivalvurintsidendi", PiirivalvurIntsidendi.findPiirivalvurIntsidendi(id));
    ...
    public String PiirivalvurIntsidendiController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("piirivalvurIntsidendi", PiirivalvurIntsidendi.findPiirivalvurIntsidendi(id));
        return "piirivalvurintsidendis/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String PiirivalvurIntsidendiController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        PiirivalvurIntsidendi.findPiirivalvurIntsidendi(id).remove();
        uiModel.asMap().clear();
